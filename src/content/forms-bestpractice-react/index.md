...
<div style="width:400px; box-shadow: 0px 0px 10px 5px rgba(0,0,0,0.025);">
...
**UI with all error messages visible**
...
<InputField type={hidepw ? "password" : "text"} name="password" handlePassword={handlePassword}/>
```
